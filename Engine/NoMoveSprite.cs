...
namespace Engine
{
    ...
    namespace Engine
    {
        ...
        /// </summary>
        public class NoMoveSprite : GameObject
        {
            /// <summary>
            ...
            public NoMoveSprite(string spriteName, float depth, int sheetIndex = 0)
            {
                this.depth = depth;
            ...
            public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
            {
                ...
                if (sprite != null)
                    sprite.Draw(spriteBatch, GlobalPosition, Origin); // haal de camerapositie eraf
            ...
            /// Returns false otherwise.</returns>
            public bool HasPixelPreciseCollision(NoMoveSprite other)
            {
                // calculate the intersection between the two bounding boxes
